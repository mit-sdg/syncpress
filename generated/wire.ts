...
export type SyncpressWire = {
  ...
  "/serve/close": {
    ...
    output: Record<string, never>;
    error: { error: AppWideError | "INVALID_INPUT" | "SERVER_CLOSE_FAILED" | "SERVER_NOT_FOUND" };
  };
  "/serve/open": {
    input: {
  ...
  "/serve/publish": {
    ...
    error: { error: AppWideError | "INVALID_INPUT" | "INVALID_SERVER" | "PUBLICATION_UNAVAILABLE" | "SERVER_NOT_OPEN" };
  };
  "/site/build": {
    input: {
  ...
  "/watch/attend": {
    ...
    error: { error: AppWideError | "INVALID_INPUT" | "INVALID_WATCH" | "WATCH_FAILED" | "WATCH_NOT_FOUND" };
  };
  "/watch/close": {
    input: {
  ...
  "/watch/open": {
    ...
    error: { error: AppWideError | "DIRECTORY_MISSING" | "DIRECTORY_UNOBSERVABLE" | "DIRECTORY_UNSUPPORTED" | "INVALID_INPUT" | "INVALID_WATCH" };
  };
};
