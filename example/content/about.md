...
[`src/concepts.ts`](https://github.com/mit-sdg/syncpress/blob/main/src/concepts.ts) lists the full inventory, and [`design/concepts/*.md`](https://github.com/mit-sdg/syncpress/tree/main/design/concepts) contains the individual contracts. This page provides the architectural overview.
...
Every interaction with the operating system is owned by the concept whose purpose it serves. [Locating](https://github.com/mit-sdg/syncpress/blob/main/design/concepts/Locating.md) observes requested host locations and their resolution-time containment. [Filing](https://github.com/mit-sdg/syncpress/blob/main/design/concepts/Filing.md) reads a complete candidate tree before replacing its logical root. [Emitting](https://github.com/mit-sdg/syncpress/blob/main/design/concepts/Emitting.md) writes and serializes destination reconciliation. [Watching](https://github.com/mit-sdg/syncpress/blob/main/design/concepts/Watching.md) owns settled change observation, [Serving](https://github.com/mit-sdg/syncpress/blob/main/design/concepts/Serving.md) owns safe preview responses and reload publication, generic [Commanding](https://github.com/mit-sdg/syncpress/blob/main/design/concepts/Commanding.md) owns invocation words, operator streams, and exit status, and [Holding](https://github.com/mit-sdg/syncpress/blob/main/design/concepts/Holding.md) owns process stop holds.
